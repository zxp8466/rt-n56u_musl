...
struct qt_disk_dqdbheader {
	uint32_t dqdh_next_free;	/* Number of next block with free
					 * entry */
	uint32_t dqdh_prev_free; /* Number of previous block with free
				   * entry */
	uint16_t dqdh_entries; /* Number of valid entries in block */
	uint16_t dqdh_pad1;
	uint32_t dqdh_pad2;
